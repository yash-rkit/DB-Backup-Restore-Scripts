#!/usr/bin/env bash
#
# Usage:   ./restore_full.sh <backup_id>
# Example: ./restore_full.sh 20260810          (or 20260810_143005)
#
set -euo pipefail
...
# LOCAL; this run's logs only — the archive is read straight from the share.
...
# Restore state — LOCAL and persistent; apply_binlog.sh reads it.
...
# Informational only — never blocks the restore.
...
# Datadir space, estimated at 4x the compressed size.
